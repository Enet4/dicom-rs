...
pub const ENTRIES: &'static [E] = &[E {
                                        tag: Tag(0x0008, 0x0005),
                                        alias: "SpecificCharacterSet",
                                        vr: VR::CS,
                                    },
                                    E {
                                        tag: Tag(0x0008, 0x0006),
                                        alias: "LanguageCodeSequence",
                                        vr: VR::SQ,
                                    },
                                    E {
                                    ...
                                    E {
                                        ...
                                        alias: "InstanceCreationDate",
                                        vr: VR::DA,
                                    },
                                    E {
                                        tag: Tag(0x0008, 0x0013),
                                        alias: "InstanceCreationTime",
                                        vr: VR::TM,
                                    },
                                    E {
                                        tag: Tag(0x0008, 0x0014),
                                        alias: "InstanceCreatorUID",
                                        vr: VR::UI,
                                    },
                                    E {
                                        tag: Tag(0x0008, 0x0015),
                                        alias: "InstanceCoercionDateTime",
                                        vr: VR::DT,
                                    },
                                    E {
                                    ...
                                    E {
                                        ...
                                        alias: "RelatedGeneralSOPClassUID",
                                        vr: VR::UI,
                                    },
                                    E {
                                        tag: Tag(0x0008, 0x001B),
                                        alias: "OriginalSpecializedSOPClassUID",
                                        vr: VR::UI,
                                    },
                                    E {
                                    ...
                                    E {
                                        ...
                                        alias: "IssuerOfAccessionNumberSequence",
                                        vr: VR::SQ,
                                    },
                                    E {
                                        tag: Tag(0x0008, 0x0052),
                                        alias: "QueryRetrieveLevel",
                                        vr: VR::CS,
                                    },
                                    E {
                                        tag: Tag(0x0008, 0x0053),
                                        alias: "QueryRetrieveView",
                                        vr: VR::CS,
                                    },
                                    E {
                                        tag: Tag(0x0008, 0x0054),
                                        alias: "RetrieveAETitle",
                                        vr: VR::AE,
                                    },
                                    E {
                                        tag: Tag(0x0008, 0x0055),
                                        alias: "StationAETitle",
                                        vr: VR::AE,
                                    },
                                    E {
                                    ...
                                    E {
                                        ...
                                        alias: "FailedSOPInstanceUIDList",
                                        vr: VR::UI,
                                    },
                                    E {
                                    ...
                                    E {
                                        ...
                                        alias: "InstitutionCodeSequence",
                                        vr: VR::SQ,
                                    },
                                    E {
                                        tag: Tag(0x4010, 0x1079),
                                        alias: "AnomalyLocatorIndicatorSequence",
                                        vr: VR::SQ,
                                    }, // DICOS
                                    E {
                                        tag: Tag(0x4010, 0x107A),
                                        alias: "AnomalyLocatorIndicator",
                                        vr: VR::FL,
                                    }, // DICOS
                                    E {
                                        tag: Tag(0x4010, 0x107B),
                                        alias: "PTORegionSequence",
                                        vr: VR::SQ,
                                    }, // DICOS
                                    E {
                                        tag: Tag(0x4010, 0x107C),
                                        alias: "InspectionSelectionCriteria",
                                        vr: VR::CS,
                                    }, // DICOS
                                    E {
                                        tag: Tag(0x4010, 0x107D),
                                        alias: "SecondaryInspectionMethodSequence",
                                        vr: VR::SQ,
                                    }, // DICOS
                                    E {
                                        tag: Tag(0x4010, 0x107E),
                                        alias: "PRCSToRCSOrientation",
                                        vr: VR::DS,
                                    }, // DICOS
                                    E {
                                        tag: Tag(0x4FFE, 0x0001),
                                        alias: "MACParametersSequence",
                                        vr: VR::SQ,
                                    },
                                    E {
                                        tag: Tag(0x5200, 0x9229),
                                        alias: "SharedFunctionalGroupsSequence",
                                        vr: VR::SQ,
                                    },
                                    E {
                                        tag: Tag(0x5200, 0x9230),
                                        alias: "PerFrameFunctionalGroupsSequence",
                                        vr: VR::SQ,
                                    },
                                    E {
                                        tag: Tag(0x5400, 0x0100),
                                        alias: "WaveformSequence",
                                        vr: VR::SQ,
                                    },
                                    E {
                                        tag: Tag(0x5400, 0x0110),
                                        alias: "ChannelMinimumValue",
                                        vr: VR::OB, /* or  or OW */
                                    },
                                    E {
                                        tag: Tag(0x5400, 0x0112),
                                        alias: "ChannelMaximumValue",
                                        vr: VR::OB, /* or  or OW */
                                    },
                                    E {
                                        tag: Tag(0x5400, 0x1004),
                                        alias: "WaveformBitsAllocated",
                                        vr: VR::US,
                                    },
                                    E {
                                        tag: Tag(0x5400, 0x1006),
                                        alias: "WaveformSampleInterpretation",
                                        vr: VR::CS,
                                    },
                                    E {
                                        tag: Tag(0x5400, 0x100A),
                                        alias: "WaveformPaddingValue",
                                        vr: VR::OB, /* or  or OW */
                                    },
                                    E {
                                    ...
                                    E {
                                        ...
                                        alias: "FirstOrderPhaseCorrectionAngle",
                                        vr: VR::OF,
                                    },
                                    E {
                                        tag: Tag(0x5600, 0x0020),
                                        alias: "SpectroscopyData",
                                        vr: VR::OF,
                                    },
                                    E {
                                        tag: Tag(0x7FE0, 0x0008),
                                        alias: "FloatPixelData",
                                        vr: VR::OF,
                                    },
                                    E {
                                        tag: Tag(0x7FE0, 0x0009),
                                        alias: "DoubleFloatPixelData",
                                        vr: VR::OD,
                                    },
                                    E {
                                    ...
                                    E {
                                        ...
                                        alias: "DigitalSignaturesSequence",
                                        vr: VR::SQ,
                                    },
                                    E {
                                        tag: Tag(0xFFFC, 0xFFFC),
                                        alias: "DataSetTrailingPadding",
                                        vr: VR::OB,
                                    },
                                    E {
                                    ...
                                    E {
                                        ...
                                        alias: "ItemDelimitationItem",
                                        vr: VR::UN,
                                    },
                                    E {
                                        tag: Tag(0xFFFE, 0xE0DD),
                                        alias: "SequenceDelimitationItem",
                                        vr: VR::UN,
                                    }];
