...
impl SpecificCharacterSet {
    ...
    #[deprecated(since = "0.5.0", note = "this value is a codec in itself")]
...
impl TextCodec for SpecificCharacterSet {
    fn name(&self) -> &'static str {
        match self {
            SpecificCharacterSet::Default => "ISO-IR 6",
            SpecificCharacterSet::IsoIr100 => "ISO-IR 100",
            SpecificCharacterSet::IsoIr101 => "ISO-IR 101",
            SpecificCharacterSet::IsoIr109 => "ISO-IR 109",
            SpecificCharacterSet::IsoIr110 => "ISO-IR 110",
            SpecificCharacterSet::IsoIr144 => "ISO-IR 144",
            SpecificCharacterSet::IsoIr192 => "ISO-IR 192",
