    ...
    S: Read,
{
    ...
    fn decode_header(&self, mut source: &mut Self::Source) -> Result<(DataElementHeader, usize)> {
        // retrieve tag
...
pub type ExplicitVRBigEndianEncoderTo<W> = EncoderFor<ExplicitVRBigEndianEncoder, W>;
